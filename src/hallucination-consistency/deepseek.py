...
def generate(directory, file_index, prompt, client, max_tokens, seed):
    ...
    os.makedirs(f"../../logs/{directory}/DeepSeek-R1-0528/max_tokens_{max_tokens}", exist_ok=True)
    # check if the file exists
    if os.path.exists(f"../../logs/{directory}/DeepSeek-R1-0528/max_tokens_{max_tokens}/qa_{file_index}.txt"):
    ...
    with open(f"../../logs/{directory}/DeepSeek-R1-0528/max_tokens_{max_tokens}/qa_{file_index}.txt", "w") as f:
        # write to the file
        f.write("**************************************** Inputs ****************************************\n")
...
if __name__ == "__main__":
    ...
    with open("../../data/hallucination-consistency/us_places.json", "r") as f:
        ...
        for place in places:
            ...
            generate("hallucination-consistency/places", index, prompt, client, max_tokens, seed)
    ...
    with open("../../data/hallucination-consistency/historical_figures.json", "r") as f:
        ...
        for figure in figures:
            ...
            generate("hallucination-consistency/historical_figures", index, prompt, client, max_tokens, seed)
    ...
    with open("../../data/hallucination-consistency/art.json", "r") as f:
        ...
        for item in art:
            ...
            generate("hallucination-consistency/art", index, prompt, client, max_tokens, seed)
