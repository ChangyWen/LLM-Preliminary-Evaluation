...
if __name__ == "__main__":
	...
	for prompt in prompts:
		...
		generate("group_1-1", index, prompt + direct_prompt, client, model_name,thinking_level, temperature, seed)
	...
	for prompt in prompts:
		print(f"Generating ({index}/{len(prompts)}) QA...")
		generate("group_1-2", index, prompt + direct_prompt, client, model_name,thinking_level, temperature, seed)
		print(f"({index}/{len(prompts)}) QA Done")
		index += 1
